...
?>
        ...
        <div class="gray-bg">
          ...
          <?PHP //echo get_post_field('post_content', 25, 'db'); ?>
            <div class="subheader">ООО «БОРСА МСК» – Это современное производство полимерной продукции полного цикла. Мы изготавливаем полипропиленовые мешки, мягкие контейнеры, полиэтиленовую пленку — самые востребованные типы упаковки.</div>
            <div class="img-2-wrapper">
              <div class="img" style="background-image:url('<?PHP bloginfo('template_url');?>/img/prodaction1.jpg')"></div>
              <div class="img" style="background-image:url('<?PHP bloginfo('template_url');?>/img/prodaction2.jpg')"></div>
            </div>
        ...
        <div class="container">
          <h3 class="h3 h3-slider">Производственная площадка ООО "БОРСА МСК"</h3>
        </div>
      </section>
      <section class="run-slider-wrapper">
        <div class="container">
          <div class="link-wrapper"><a class="runSlider" href="#" title="title" data-slide="testslider2" style="background-image:url('<?PHP echo wp_get_attachment_image_url(carbon_get_the_post_meta('production_photo'), 'large'); ?>')" id="runSlider">
