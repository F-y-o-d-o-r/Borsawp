            ...
            <div class="news-wrapper">
              ...
              <div class="content">
                ...
                <div class="run-slider-wrapper">
                  <div class="link-wrapper"><a class="runSlider" href="#" title="title" data-slide="testslider2" style="background-image:url('img/slider/fore.jpg')" id="runSlider">
                    ...
                    <p>XXIV международная специализированная торгово-промышленная выставка «MVC: Зерно-Комбикорма-Ветеринария-2019» (12 фотогрфий)</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="container"><img class="close-popup" src="img/close.svg" alt="close" id="closePopup">
          <div class="hidden-slider-wrapper">
            <div class="slick-popup-slider" id="slick">
              <div class="slide" style="background-image: url('img/slider/fore.jpg')"></div>
